...
class ForecastViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let santacruz = Location(name: "Santa Cruz", latitude: 36.9741 , longitude: -122.0307)
        let cincinnati = Location(name: "Cincinnati", latitude: 39.1031, longitude: -84.5120)
        
        
        locations = [sanJose, manila, italy, santacruz, cincinnati]
